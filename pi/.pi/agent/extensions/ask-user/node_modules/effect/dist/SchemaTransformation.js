...
export const durationFromString = /*#__PURE__*/transformOrFail({
  decode: s => Option.match(Duration.fromInput(s), {
    onNone: () => Effect.fail(new SchemaIssue.InvalidValue(Option.some(s), {
...
export const durationFromNanos = /*#__PURE__*/transformOrFail({
  ...
  encode: a => Option.match(Duration.toNanos(a), {
    onNone: () => Effect.fail(new SchemaIssue.InvalidValue(Option.some(a), {
...
export const urlFromString = /*#__PURE__*/transformOrFail({
  decode: s => URL.canParse(s) ? Effect.succeed(new URL(s)) : Effect.fail(new SchemaIssue.InvalidValue(Option.some(s), {
...
export const bigDecimalFromString = /*#__PURE__*/transformOrFail({
  decode: s => {
    ...
    return Option.isNone(result) ? Effect.fail(new SchemaIssue.InvalidValue(Option.some(s), {
 ...
 * @since 4.0.0
 */
export const fromJsonString = /*#__PURE__*/new Transformation(/*#__PURE__*/SchemaGetter.parseJson(), /*#__PURE__*/SchemaGetter.stringifyJson());
/**
