 ...
 * @since 4.0.0
 */
export declare const layerHandlers: Layer.Layer<import("../rpc/Rpc.ts").Handler<"Effect"> | import("../rpc/Rpc.ts").Handler<"Envelope"> | import("../rpc/Rpc.ts").Handler<"Notify"> | import("../rpc/Rpc.ts").Handler<"Ping"> | import("../rpc/Rpc.ts").Handler<"Stream">, never, MessageStorage.MessageStorage | Sharding.Sharding>;
/**
