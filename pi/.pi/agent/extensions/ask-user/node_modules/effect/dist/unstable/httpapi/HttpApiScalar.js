...
<html>
  <head>
    ...
    ${!spec.info.description ? "" : `<meta name="description" content="${Html.escapeAttribute(spec.info.description)}"/>`}
    ${!spec.info.description ? "" : `<meta name="og:description" content="${Html.escapeAttribute(spec.info.description)}"/>`}
    <meta
      name="viewport"
