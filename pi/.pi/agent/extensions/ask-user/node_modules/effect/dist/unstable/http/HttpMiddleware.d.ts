 ...
 * @since 4.0.0
 */
export declare const xForwardedHeaders: <E, R>(httpApp: Effect.Effect<HttpServerResponse, E, R | HttpServerRequest>) => Effect.Effect<HttpServerResponse, E, R | HttpServerRequest>;
/**
