...
export const Record = (key, value, options) => {
  ...
  const recordString = Schema.String.pipe(Schema.decodeTo(Schema.Record(Schema.String, Schema.String), SchemaTransformation.splitKeyValue(options)), Schema.decodeTo(record));
...
const ArrayConfig = (value, options) => {
  ...
  const arrayString = Schema.String.pipe(Schema.decodeTo(Schema.Array(Schema.String), {
