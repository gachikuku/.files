...
declare const EventLogRemoteClient_base: Context.ServiceClass<EventLogRemoteClient, "effect/unstable/eventlog/EventLogRemote/EventLogRemoteClient", {
    readonly "EventLog.Authenticate": <const AsQueue extends boolean = false, const Discard = false>(input: Schema.Struct.ReadonlyMakeIn<{
        readonly publicKey: Schema.String;
        readonly signingPublicKey: import("../workers/Transferable.ts").Transferable<Schema.instanceOf<Uint8Array<ArrayBuffer>, Uint8Array<ArrayBuffer>>>;
        readonly signature: import("../workers/Transferable.ts").Transferable<Schema.instanceOf<Uint8Array<ArrayBuffer>, Uint8Array<ArrayBuffer>>>;
    ...
    readonly "EventLog.Changes": <const AsQueue extends boolean = false, const Discard = false>(input: Schema.Struct.ReadonlyMakeIn<{
    ...
    readonly "EventLog.WriteSingle": <const AsQueue extends boolean = false, const Discard = false>(input: Schema.Struct.ReadonlyMakeIn<{
        data: import("../workers/Transferable.ts").Transferable<Schema.instanceOf<Uint8Array<ArrayBuffer>, Uint8Array<ArrayBuffer>>>;
    }>, options?: {
        readonly headers?: import("../http/Headers.ts").Input | undefined;
        readonly context?: Context.Context<never> | undefined;
        readonly discard?: Discard | undefined;
