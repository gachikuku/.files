 ...
 * @since 4.0.0
 */
export declare const decodeDataSchema: <Type, DecodingServices, IE, Done>(schema: Schema.ConstraintDecoder<Type, DecodingServices>) => Channel.Channel<NonEmptyReadonlyArray<{
