...
export function run(ast) {
  ...
  return (input, options) => Effect.flatMapEager(parser(Option.some(input), options ?? SchemaAST.defaultParseOptions), oa => {
    if (oa._tag === "None") {
