...
declare const TypeId = "~effect/LayerRef";
/**
 ...
 * @since 4.0.0
 */
export declare const make: <I, E, R, X, const Preload extends boolean = never, SE = never, SR = never>(layer: Layer.Layer<I, E, R>, options?: {
    /**
...
} | undefined) => Effect.Effect<LayerRef<I, E>, [Preload] extends [true] ? E : never, R | SR | Scope.Scope>;
/**
 ...
 * @since 4.0.0
 */
export interface TagClass<in out Self, in out Id extends string, in out I, in out E, in out R, in out LE, in out Deps extends Layer.Layer<any, any, any>> extends Context.ServiceClass<Self, Id, LayerRef<I, E>> {
    /**
 ...
 * @since 4.0.0
 */
export declare const Service: <Self>() => <const Id extends string, I, E, R, X, const Deps extends ReadonlyArray<Layer.Layer<any, any, any>> = [], const Preload extends boolean = never, SE = never, SR = never>(id: Id, options: {
    /**
...
export {};
//# sourceMappingURL=LayerRef.d.ts.map